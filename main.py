...
UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "")  # Public channel username for force sub
ADMIN_IDS = [int(x) for x in os.getenv("ADMIN_IDS", "").split()]  # List of admin user IDs
